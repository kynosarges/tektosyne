...
/**
 * Provides unit tests for class {@link PointDComparatorY}.
 * @author Christoph Nahr
 * @version 6.0.0
 */
public class PointDComparatorYTest {

    private final PointDComparatorY comparer = new PointDComparatorY(0);
    private final PointDComparatorY comparer001 = new PointDComparatorY(0.01);
    private final PointDComparatorY comparer02 = new PointDComparatorY(0.2);
    private final PointDComparatorY comparer05 = new PointDComparatorY(0.5);
    ...
    public void testCompareEpsilonStatic() {
        assertEquals(-1, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(1.1, 2), 0.01));
        assertEquals(-1, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(1, 2.1), 0.01));
        assertEquals(+1, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(0.9, 2), 0.01));
        assertEquals(+1, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(1, 1.9), 0.01));

        assertEquals(0, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(1.1, 2), 0.5));
        assertEquals(0, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(1, 2.1), 0.5));
        assertEquals(0, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(0.9, 2), 0.5));
        assertEquals(0, PointDComparatorY.compareEpsilon(new PointD(1, 2), new PointD(1, 1.9), 0.5));
    }

    @Test
    public void testCompareExact() {
        assertEquals(0, PointDComparatorY.compareExact(new PointD(1, 2), new PointD(1, 2)));
        assertEquals(-1, PointDComparatorY.compareExact(new PointD(1, 2), new PointD(2, 2)));
        assertEquals(-1, PointDComparatorY.compareExact(new PointD(1, 2), new PointD(1, 3)));
        assertEquals(+1, PointDComparatorY.compareExact(new PointD(1, 2), new PointD(0, 2)));
        assertEquals(+1, PointDComparatorY.compareExact(new PointD(1, 2), new PointD(1, 1)));

        assertEquals(+1, PointDComparatorY.compareExact(new PointD(1, 2), new PointD(2, 1)));
        assertEquals(-1, PointDComparatorY.compareExact(new PointD(2, 1), new PointD(1, 2)));
    }
    ...
    public void testFindNearestEpsilonOverlap() {
        points.clear();
        for (int i = 0; i < POINTS_COUNT; i++)
            points.add(new PointD(i / 10, (i % 10) / 10.0));
    ...
    public void testFindRangeEpsilon() {
        ...
        rect = new RectD(0.1, 0.1, 9.9, 8.9);
        range = comparer02.findRange(pointMap02, rect).navigableKeySet();
        assertEquals(range, comparer02.findRange(pointMapKeys, rect));
        assertEquals(pointMapKeys, range);
